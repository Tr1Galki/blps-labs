package lab.user_service.transaction.config;
...
@EnableJpaRepositories(
        basePackages = {
                "lab.user_service.article.repository",
                "lab.user_service.security.repository"
        },
...
public class RepositoryConfig {
    ...
    public LocalContainerEntityManagerFactoryBean myEntityManager() {
        ...
        entityManagerFactory.setPackagesToScan("lab.user_service.*");
